    ...
    _createClass(Brush, [
        ...
        },
        {
            ...
            value: function renderHandles() {
                ...
                var handleDefaultStyle = {
                    fill: "white",
                    opacity: 0,
                    cursor: "ew-resize"
                };

                var mergedHandleStyle = (0, _merge2.default)(true, handleDefaultStyle, handleStyle);
...
Brush.propTypes = {
     ...
     * of this rect using this prop.
     */
    handleStyle: _propTypes2.default.object, //eslint-disable-line
