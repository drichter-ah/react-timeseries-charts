...
export default class Brush extends React.Component {
    ...
    renderHandles() {
        const { timeRange, timeScale, height, handleStyle } = this.props;
        ...
        const mergedHandleStyle = merge(true, handleDefaultStyle, handleStyle);
...
Brush.propTypes = {
    ...
    /**
     * The handle is rendered as an SVG rect. You can specify the style
     * of this rect using this prop.
     */
    handleStyle: PropTypes.object, //eslint-disable-line
